...
L'objectif de ce guide est d'introduire à l'installation d'Arch Linux et de quelques packages essentiels. Il a été conçu pour un public parlant le Français.

## Index : 
- Installation d'Arch linux :
    - [Création de la clé d'installation](https://github.com/rafalou38/Guide-arch-Linux-du-Taupin/blob/main/arch/01-ISO.md)
    - [Initialisation du système](https://github.com/rafalou38/Guide-arch-Linux-du-Taupin/blob/main/arch/02-Initialisation.md)
